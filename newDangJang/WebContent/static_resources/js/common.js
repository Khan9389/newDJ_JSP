...
function cf_call(url, params, callback, isloadingbar, option) {
	
	if(cf_isEmpty(options)) option = {
		headers : {
	...
	axios.post(url, params, option)
		.then(function(response) {
			...
			if(rsltFailArr.includes(response.data.rsltStatus)) {
				if(response.data.rsltStatus == "user-error" && !cf_isEmpty(response.data.errMrg)) {
